...
- ## **As a website owner I want that:**
    ...
    2. The website allows the user to sign up for the workshop and selecting what level of skill they are in photography.
------
...
- ## **As a returning website user I want:**
    1. To be able to check course timetable quickly.
...
- For mobile and tablet view the logo has been centered and the navigation items moved just below the logo to keep the design mobile friendly.
...
- The 'workshop schedule' section gives users clear and concise information about what days and times the worskhop is open.
- The 'sign up' section has a simple form with radio buttons asking what skill the user is at.
- The 'footer' section provides quickly links to the workshops social media platforms where the user can follow the business. 
...
# 5. Surface
 - ## **Color**
    - The color theme is based on orange and teal design. The images have been picked with the main color being orange and slight hint of teal.
    - The sign up form button and text input border was #e06004 (shade of orange) to reflect a similar orange used in the images.
 ...
 - ## **Font**
    - The font 'Lato' was used through out the website and was imported from Google Fonts.
 - ## **Favicon**
    - The favicon I opted to use was the first letter of the website name which consiquently is also the logo. I chose the color '#f1db23' (a shade of yellow) to keep the design the same.
...
- ## **Sign Up Form**
    ...
    - The following details are mandatory for using this form:
        ...
        2. Last Name
        3. Email
        4. Choosing a radio button stating what skill level the user is; ie. Beginner, Intermiadiate or hobbyist.
...
- ## Languages
    ...
    - CSS3
- ## Misc. Software
    - Google Fonts - 'Lato' was used through out the website.
    - Font Awesome - Icons used for social media were taken from Font Awesome.
    - Favicon - Favicon used to convert 'PNG' into a favicon 'ICO' format.
    - Balsamiq - Wireframes (sketches) were created using Balsamiq.
